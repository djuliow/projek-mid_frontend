    ...
    <section id="contact" className="py-20 bg-gray-100">
      <div className="container mx-auto px-4">
        ...
        <div className="md:flex md:space-x-8 max-w-4xl mx-auto">
          <Fade direction="left" delay={200} duration={1000} className="md:w-1/2">
          ...
          <Fade direction="right" delay={200} duration={1000} className="md:w-1/2">
            <div className="bg-white rounded-lg shadow-md p-8 mb-10 md:mb-0 h-full">
